...
class Parser:
    ...
    def expr(self):
        """ Парсер для арифметичних виразів з урахуванням всіх операцій. """
        node = self.term()
...
# Додаємо функцію print_ast поза класами
...
class Interpreter:
    ...
    def interpret(self):
        ...
        # print("Побудоване дерево синтаксичного аналізу (AST):")
        # print_ast(tree)  # Виклик функції print_ast для відображення дерева
